...
namespace BookifyNew
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BFDBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Database")));
            ...
            services.AddSession();
            services.AddTransient<IProducts, ProductDataContext>();
